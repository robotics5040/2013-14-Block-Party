...
task main()
{
  ...
  while (true)
  {
	  ...
	  if ((joystick.joy1_y2 < 5 && joystick.joy1_y2 > -5) || esMotors) //Threshold & Preset Speed Button - RSD - 0
	  {
	  	if(toggleFront == false)
	  	{
	  		motor[motorH] = 0;
	  		motor[motorI] = 0;
	  	}
		...
		if ((joystick.joy1_y1 < 5 && joystick.joy1_y1 > -5) || esMotors) //Threshold & Preset Speed Button - LSD - 0
		{
			if(toggleFront == false)
	  	{
	  		motor[motorF] = 0;
